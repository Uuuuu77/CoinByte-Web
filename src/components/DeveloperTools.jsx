...
const developerTools = [
  ...
  },
  {
    ...
    cta: "Explore Wallet",
    url: EXTERNAL_LINKS.identityWallet,
              ...
              >
                ...
                <div className="relative card p-8 h-full flex flex-col border-2 border-primary-orange/20 hover:border-primary-orange/40">
                  ...
                  <motion.button
                    ...
                    onClick={() => openExternalLink(tool.url, 'ecosystem_tool_clicked', { tool: tool.title })}
                  >
                    {tool.cta}
          ...
          <div className="card max-w-4xl mx-auto p-8 bg-gradient-to-r from-primary-orange/5 to-primary-gold/5 border-primary-orange/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.button
                ...
                onClick={() => openExternalLink(EXTERNAL_LINKS.github, 'github_clicked')}
              >
                View on GitHub
              </motion.button>
            </div>
