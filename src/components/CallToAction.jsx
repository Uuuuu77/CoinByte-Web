        ...
        >
          ...
          <div className="mt-12 card inline-flex items-center gap-4 px-8 py-4 bg-primary-black/50">
            <div className="flex items-center gap-2 text-sm text-secondary-light/90">
              ...
              <img src="/assets/mpesa-logo.png" alt="M-Pesa" className="h-6 opacity-80" />
              <img src="/assets/flutterwave-logo.png" alt="Flutterwave" className="h-5 opacity-80" />
              <img src="/assets/celo-logo.png" alt="Celo" className="h-4 opacity-80" />
            </div>
          </div>
